...
<head>
    ...
    <style>
        * {
        ...
        /* Info receveur - Blanc avec bordure rouge */
        .receiver-info {
            background: white;
            color: #1a1a1a;
            border-radius: 12px;
        ...
        /* Animations en cascade pour les cartes de donneurs */
        .donor-card:nth-child(1) { animation-delay: 0.15s; }
        .donor-card:nth-child(2) { animation-delay: 0.25s; }
        .donor-card:nth-child(3) { animation-delay: 0.35s; }
        .donor-card:nth-child(4) { animation-delay: 0.45s; }
        .donor-card:nth-child(5) { animation-delay: 0.55s; }
