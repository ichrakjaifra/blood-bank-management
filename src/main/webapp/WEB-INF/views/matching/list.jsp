        ...
        <c:choose>
            <c:when test="${empty donations}">
                <div class="empty-state">
                    ...
                    <p>Il n'y a pas de donations pour le moment</p>
                </div>
            </c:when>
            <c:otherwise>
                <table class="table">
                    ...
                    <c:forEach var="donation" items="${donations}">
                        <tr>
                            <td><strong>${donation.donor.fullName}</strong></td>
                            <td><strong>${donation.receiver.fullName}</strong></td>
                            <td>
                                <span class="badge badge-red">${donation.donor.bloodGroup.displayName}</span>
                            </td>
                            <td>
                                <span class="badge" style="background-color: #dbeafe; color: #1e40af;">${donation.receiver.bloodGroup.displayName}</span>
                            </td>
                            ...
                            <td>
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <span class="badge" style="background-color: #f3f4f6; color: #4b5563;">Annulée</span>
                                    </c:otherwise>
                                </c:choose>
                            </td>
                            <td>
